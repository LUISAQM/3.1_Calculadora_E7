...
function pi() {
         x=Math.PI //resolver pi
         pantalla.innerHTML=x; //mostrar en pantalla resultado
         op="no"; //quitar operaciones pendientes.
         xi=1; //se puede reiniciar la pantalla 
         }         
function sen() {
         x=Math.sin(x)//resolver sen
         pantalla.innerHTML=x; //mostrar en pantalla resultado
         op="no"; //quitar operaciones pendientes.
         xi=1; //se puede reiniciar la pantalla 
         }
function cos() {
         x=Math.cos(x)//resolver cos
         pantalla.innerHTML=x; //mostrar en pantalla resultado
         op="no"; //quitar operaciones pendientes.
         xi=1; //se puede reiniciar la pantalla 
         }
function tan() {
         x=Math.tan(x) //resolver tan
         pantalla.innerHTML=x; //mostrar en pantalla resultado
         op="no"; //quitar operaciones pendientes.
         xi=1; //se puede reiniciar la pantalla 
         }
function elv() { let exponente = prompt('Indique el numero de exponente')
         x=Math.pow(x, exponente); //exponenciar numero
         pantalla.innerHTML=x; //mostrar en pantalla resultado
         op="no"; //quitar operaciones pendientes.
         xi=1; //se puede reiniciar la pantalla 
         }
function cambiabase() { let base = prompt('Indique el numero de base')
         let y=x.toString(base);
         pantalla.innerHTML=y; //mostrar en pantalla resultado
         op="no"; //quitar operaciones pendientes.
         xi=1; //se puede reiniciar la pantalla 
         }
